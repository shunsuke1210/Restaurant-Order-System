...
-- spec完了後のユーザー確認で拡張: 当初はC1・C2・T1・T2の4卓のみだった
-- （このファイルが本来「動作確認を始められる最低限のデータ」を目的として
-- おり、mock-preview.htmlの卓数を再現する意図が無かったため）。
-- mock-preview.htmlの`state.tables`（C1〜C6・T1〜T5の計11卓、満席30〜40人
-- 規模の居酒屋という想定に合わせた卓数）と一致させ、卓マップの見え方を
-- モックに揃える。`FloorMap.tsx`のエリア分けはラベル接頭辞（`/^T/`・
-- `/^C/`）のみに依存するため、卓数を増やすのに本ファイル以外の変更は
-- 不要（design.mdのNon-Goals「卓自体の登録機能は本spec範囲外」の通り）。
...
values
  ...
  ('11111111-1111-4111-8111-111111111105', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'C3'),
  ('11111111-1111-4111-8111-111111111106', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'C4'),
  ('11111111-1111-4111-8111-111111111107', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'C5'),
  ('11111111-1111-4111-8111-111111111108', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'C6'),
  ...
  ('11111111-1111-4111-8111-111111111109', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'T3'),
  ('11111111-1111-4111-8111-111111111110', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'T4'),
  ('11111111-1111-4111-8111-111111111111', 'd7c26e3a-c0c6-4db6-b6ba-d913b3145562', 'T5')
on conflict (id) do nothing;
